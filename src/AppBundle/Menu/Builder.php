...
class Builder implements ContainerAwareInterface
{
      ...
      public function mainUserMenu(FactoryInterface $factory,array $options){
          ...
          $menu->addChild('Next of Kin/Beneficiary',array('route'=>'my-next-of-kin'));
          $menu['Next of Kin/Beneficiary']->addChild('Add Next of Kin/Beneficiary',array('route'=>'add-next-of-kin'));
